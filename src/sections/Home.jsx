...
export default function Home() {
  const roles = useMemo(() => ["Web Developer", "Software Developer", "DSA in C++"], []);
  ...
  return (
    <section id="home" className="w-full h-screen relative bg-black overflow-hidden">
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            {/* Typing animation */}
            <motion.div
              className="mb-3 text-xl sm:w-2xl md:text-3xl lg:text-4xl font-semibold text-white tracking-wide min-h-[1.6em]"
      ...
      <motion.img src={avator} alt="Shubham singh"
